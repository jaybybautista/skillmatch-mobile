            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('Add Resume', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: AppColors.primary)),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(resume.title, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: AppColors.primary)),
                const SizedBox(height: 8),
                const Divider(),
                ListTile(
      ...
      builder: (sheetContext) {
        return Padding(
          ...
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: [
              const Text('Rename Resume', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: AppColors.primary)),
              const SizedBox(height: 12),
              TextField(controller: controller, autofocus: true),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Resume Builder', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
        actions: [
