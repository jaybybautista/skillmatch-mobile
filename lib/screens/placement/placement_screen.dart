        ...
        children: [
          const Row(
            children: [
              ...
              SizedBox(width: 8),
              Text('Log Daily Work Hours', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
            ],
          ),
          const SizedBox(height: 16),
          const Text(
        ...
        children: [
          const Row(
            children: [
              ...
              SizedBox(width: 8),
              Text('Latest Supervisor Remarks', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
            ],
          ),
          const SizedBox(height: 10),
