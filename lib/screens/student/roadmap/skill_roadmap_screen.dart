...
class _SkillRoadmapScreenState extends State<SkillRoadmapScreen> {
  late final SkillRoadmapService _service =
      widget.service ?? SkillRoadmapService();
    ...
    return ListView(
      ...
      children: [
        ...
        _SkillsSection(
          ...
          hint:
              'The most in-demand skills across open postings that aren\'t on your profile yet.',
